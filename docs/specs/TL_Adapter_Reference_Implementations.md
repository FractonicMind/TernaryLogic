...
{  
  ...
  "data": {  
    "input_digest": "sha256-hash",  
    "candidate_action": "proposed-action-object",  
    "risk_assessment": {  
      "harm_probability": 0.62,  
      "confidence_interval": [0.45, 0.70],  
      "reasoning_trace": "optional-explanation"  
    },  
...
- **Extensibility**: Custom fields in UDE data object should be prefixed (e.g., `x_vendor_`)  
