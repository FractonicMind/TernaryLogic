...
The Muller C-element fires at 50ms. The Epistemic Hold releases at 50ms. Execution is authorized at 50ms. No external infrastructure is on this critical path.
...
| Gap 3 | Buffer threshold numbers not connected to physical flow control | **Resolved in PPT folder** |
...
Gap 3 and the external I/O rollback gap are resolved by the **Reversibility Boundary** and **Shadow Buffer Gate** in the [`PPT/`](https://github.com/FractonicMind/TernaryLogic/tree/main/PPT) implementation folder. See the Resolution Addendum in the gaps document.
...
### PPT Hardware Implementation

The complete hardware implementation of the PPT within the DLLA — synthesizable RTL, TLA+ formal proofs, cryptographic pipeline integration, Governor Independence specification, and adversarial review — is maintained in the [`PPT/`](https://github.com/FractonicMind/TernaryLogic/tree/main/PPT) folder.

| Component | File |
|---|---|
| PPT lifecycle and Reversibility Boundary | [`PPT/01_Architecture_Specs/PPT_Lifecycle.md`](https://github.com/FractonicMind/TernaryLogic/blob/main/PPT/01_Architecture_Specs/PPT_Lifecycle.md) |
| C-element Verilog RTL | [`PPT/02_Hardware_Primitives/C_Element_Interlock.v`](https://github.com/FractonicMind/TernaryLogic/blob/main/PPT/02_Hardware_Primitives/C_Element_Interlock.v) |
| Shadow Buffer Gate RTL (Class I port control) | [`PPT/02_Hardware_Primitives/Shadow_Buffer_Gate.v`](https://github.com/FractonicMind/TernaryLogic/blob/main/PPT/02_Hardware_Primitives/Shadow_Buffer_Gate.v) |
| Countdown timer + Epoch Hold RTL | [`PPT/02_Hardware_Primitives/Countdown_Timer_Clock.v`](https://github.com/FractonicMind/TernaryLogic/blob/main/PPT/02_Hardware_Primitives/Countdown_Timer_Clock.v) |
| SHA-256 + Merkle pipeline RTL | [`PPT/03_Cryptographic_Pipeline/`](https://github.com/FractonicMind/TernaryLogic/tree/main/PPT/03_Cryptographic_Pipeline) |
| TLA+ formal state machine | [`PPT/04_Formal_Verification/PPT_State_Transitions.tla`](https://github.com/FractonicMind/TernaryLogic/blob/main/PPT/04_Formal_Verification/PPT_State_Transitions.tla) |
| Governor Independence (50ms marker) | [`PPT/05_Research/Governor_Independence_Note.md`](https://github.com/FractonicMind/TernaryLogic/blob/main/PPT/05_Research/Governor_Independence_Note.md) |
| Academic paper | [`PPT/06_Publication/PPT_Paper_Draft.md`](https://github.com/FractonicMind/TernaryLogic/blob/main/PPT/06_Publication/PPT_Paper_Draft.md) |
...
- [DLLA_ENGINEERING_GAPS_v1.md](https://github.com/FractonicMind/TernaryLogic/blob/main/Dual_Latency_Architecture/DLLA_ENGINEERING_GAPS_v1.md) -- Five gaps and resolutions. Read before synthesis.
