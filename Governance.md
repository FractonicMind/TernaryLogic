...
**Mandate:** The Technical Council is charged with the technical evolution, cryptographic security, and operational performance of the TL protocol. Its structure is analogous to a permanent, high-authority "technical oversight committee" common in mission-critical open-source systems.8  
**Obligations:**
...
2. **Audit Access:** The right to access all immutable Decision Logs for audit, ensuring transparency of all governance actions.7  
...
This Article defines the human layer of governance. The composition, terms, and rotation schedules are engineered to balance deep, mature judgment and domain expertise with robust, long-term resistance to capture, power consolidation, and conflicts of interest.9
...
1. **Proposal:** The Technical Council drafts a Type 3 proposal (e.g., a new cryptographic algorithm) and passes it with an internal $\\ge 75\\%$ supermajority vote.  
