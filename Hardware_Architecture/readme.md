...
This repository contains the engineering research and architectural specifications for **Hardware-Intrinsic Ternary** computing. It serves as the physical foundation for the **Ternary  Logic (TL)** governance framework.
