...
1. [\[PDF\] Ternary Moral Logic (TML)](https://d197for5662m48.cloudfront.net/documents/publicationstatus/287026/preprint_pdf/1b4a89de8ade539eca8254930e5647d0.pdf)

2. [SDPS 2021 Proceedings-1.pdf](https://openarchive.usn.no/usn-xmlui/bitstream/handle/11250/3068469/2021GundersenTernary.pdf?sequence=4&isAllowed=y)

3. [BIS Project Agorá moves from blueprint to reality](https://paymentsindustryintelligence.com/bis-project-agora-moves-from-blueprint-to-reality/) \- At its core, Project Agorá seeks to integrate tokenised commercial bank deposits with tokenised cent...

4. [\[PDF\] Project Agorá – Frequently Asked Questions](https://www.bis.org/innovation_hub/projects/agora_faq.pdf) \- The project aims to test the desirability, feasibility and viability of a multi-currency unified led...

5. [AI Risk Classification: Guide to EU AI Act Risk Categories](https://gdprlocal.com/ai-risk-classification/) \- AI risk classification under the EU AI Act determines which compliance obligations apply to your art...

6. [Understanding EU AI Act Risk Categories](https://www.securitycompass.com/blog/understanding-eu-ai-act-risk-categories/) \- The European Union (EU) AI Act is the first comprehensive legislative framework of its kind. It aims...

7. [Article 6: Classification Rules for High-Risk AI Systems](https://artificialintelligenceact.eu/article/6/)

8. [AI principles \- OECD](https://www.oecd.org/en/topics/sub-issues/ai-principles.html) \- The OECD AI Principles promote use of AI that is innovative and trustworthy and that respects human ...

9. [Global AI Governance: Five Key Frameworks Explained \- Bradley](https://www.bradley.com/insights/publications/2025/08/global-ai-governance-five-key-frameworks-explained)

10. [EU AI Act: Risk-Classifications of the AI Regulation \- trail](https://www.trail-ml.com/blog/eu-ai-act-how-risk-is-classified) \- Learn about the proposed risk classes of the EU AI Act. We provide examples, details about high-risk...

11. [Modeling Adversaries with TLA+](https://www.hillelwayne.com/post/adversaries/) \- A common question I get about specs is how to model bad actors. Usually this is one of two contexts:...

12. [BIS Project Agorá enters testing phase for tokenized cross border ...](https://www.ledgerinsights.com/bis-project-agora-enters-testing-phase-for-tokenized-cross-border-payments/) \- Agorá involves integrating private sector tokenized deposits and tokenized central bank money or who...

13. [Key OECD AI governance initiatives \- EvalCommunity Academy](https://academy.evalcommunity.com/key-oecd-ai-governance-initiatives/) \- It sets five principles for trustworthy AI: Inclusive growth and sustainable development: AI should ...

14. [OECD AI Principles Overview \- Digital Government Hub](http://digitalgovernmenthub.org/library/oecd-ai-principles-overview/) \- OECD AI Principles Overview. The OECD AI Principles promote use of AI that is innovative and trustwo...
